					...
					<div class="owl-carousel owl-carousel-fullwidth">
						<div class="item">
							<div class="testimony-slide active text-center">
								<figure>
									<img src="/frontend/images/person_1.jpg" alt="user">
								</figure>
						...
						<div class="item">
							<div class="testimony-slide active text-center">
								<figure>
									<img src="/frontend/images/person_2.jpg" alt="user">
								</figure>
						...
						<div class="item">
							<div class="testimony-slide active text-center">
								<figure>
									<img src="/frontend/images/person_3.jpg" alt="user">
								</figure>
								<span>John Doe, via <a href="#" class="twitter">Twitter</a></span>
								<blockquote>
		...
		<div class="row">
			<div class="col-lg-4 col-md-4">
				<div class="fh5co-blog animate-box">
					<a href="#"><img class="img-responsive" src="/frontend/images/project-4.jpg" alt=""></a>
					<div class="blog-text">
			...
			<div class="col-lg-4 col-md-4">
				<div class="fh5co-blog animate-box">
					<a href="#"><img class="img-responsive" src="/frontend/images/project-2.jpg" alt=""></a>
					<div class="blog-text">
			...
			<div class="col-lg-4 col-md-4">
				<div class="fh5co-blog animate-box">
					<a href="#"><img class="img-responsive" src="/frontend/images/project-3.jpg" alt=""></a>
					<div class="blog-text">
						<h3><a href=""#>45 Minimal Workspace Rooms for Web Savvys</a></h3>
						<span class="posted_on">Nov. 15th</span>
						<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
